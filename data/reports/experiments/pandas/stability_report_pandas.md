# Model Consistency Analysis: pandas
...
|---|---|---|
| **Checklist Consistency** (Avg Pairwise Kappa) | 0.865 | Perfect/Almost Perfect |
| **Score Stability** (Avg Variance) | 0.000 | Lower is better (0 = Perfect) |
| **Evidence Stability** (Avg Pairwise IoU) | 0.518 | Higher is better (1 = Perfect) |
